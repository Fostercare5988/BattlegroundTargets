-- -------------------------------------------------------------------------- --
-- BattlegroundTargets Options & Configuration GUI                            --
-- -------------------------------------------------------------------------- --

local BattlegroundTargets = BattlegroundTargets
if not BattlegroundTargets then return end
...
local GVAR = BattlegroundTargets.GVAR
local TEMPLATE = BattlegroundTargets.TEMPLATE
local OPT = BattlegroundTargets.OPT

local Textures = BattlegroundTargets.Textures
local classes = BattlegroundTargets.classes
local classcolors = BattlegroundTargets.classcolors
local class_IntegerSort = BattlegroundTargets.class_IntegerSort
local battleFieldRoleIcons = BattlegroundTargets.battleFieldRoleIcons
local roleLayoutPos = BattlegroundTargets.roleLayoutPos
local bgSize = BattlegroundTargets.bgSize
local bgSizeINT = BattlegroundTargets.bgSizeINT
local startMapCoordsA = BattlegroundTargets.startMapCoordsA
local Print = BattlegroundTargets.Print
local HDLog = BattlegroundTargets.HDLog
local contains = BattlegroundTargets.contains
local inRange = BattlegroundTargets.inRange
local ClassHexColor = BattlegroundTargets.ClassHexColor
local Desaturation = BattlegroundTargets.Desaturation
local NOOP = BattlegroundTargets.NOOP
local GetRealCoords = BattlegroundTargets.GetRealCoords
local isStartPosition = BattlegroundTargets.isStartPosition
